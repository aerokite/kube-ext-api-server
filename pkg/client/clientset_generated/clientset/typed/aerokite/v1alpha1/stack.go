...
import (
	...
	scheme "github.com/aerokite/kube-ext-api-server/pkg/client/clientset_generated/clientset/scheme"
...
type StackInterface interface {
	...
	UpdateStatus(*v1alpha1.Stack) (*v1alpha1.Stack, error)
...
func newStacks(c *AerokiteV1alpha1Client, namespace string) *stacks {
	return &stacks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *stacks) UpdateStatus(stack *v1alpha1.Stack) (result *v1alpha1.Stack, err error) {
	result = &v1alpha1.Stack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stacks").
